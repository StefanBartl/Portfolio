...
if(document.querySelector(".section-introduction")){
     ...
     introduction_headlineTwo = document.querySelector(".introduction-headline-two");
     introduction_headlineThree = document.querySelector(".introduction-headline-three");
     introduction_headlineOutro = document.querySelector(".introduction-headline-outro");
     introduction_paragraphOne = document.querySelector(".introduction-paragraph-one");
     introduction_paragraphTwo = document.querySelector(".introduction-paragraph-two");
};
//#endregion
...
if(document.querySelector(".section-about")){
     ...
     about_headline_three = document.querySelector(".about-headline-three");
