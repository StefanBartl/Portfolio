...
/*
!                         Portfolio about.js-Javascript-File
?                                      powered by
!                                      Stefan Bartl
...
const audio = new Audio("audio/inkompetech_com/Late Night Radio.mp3");
audio.load();
audio.loop = true;
...
//console.log(`Èntered Audio-Settings Function in about.js.`);

// load correct sound toggle image 
    localStorage.Sound !== "on" 
        ? musicnote.src = "graphics/images/music_notes_dance/music_notes_dance_grey_bg.png"
        : musicnote.src = "graphics/images/music_notes_dance/music_notes_dance_orange_bg.png";
